...
uint_fast8_t np_c4_minimax(const board& prev_board, const _c4_brain::c4_brain* brain, const uint_fast8_t first_player = 0,
	const uint_fast8_t depth = np_sdepth, const bool chain_games = 0, const uint_fast8_t chain_player = 0, const bool print = 0);

uint_fast8_t np_minimax(const board& board, const bool max, const uint_fast8_t player, const uint_fast8_t move, 
	const uint_fast8_t depth, const _c4_brain::c4_brain* brain,
...
int_fast8_t np_ai_play_ai(const _c4_brain::c4_brain* brain1, const _c4_brain::c4_brain* brain2,
	uint_fast8_t depth1, uint_fast8_t depth2, const bool chain_games = 0, const uint_fast8_t chain_player = 0, bool print = 0);
